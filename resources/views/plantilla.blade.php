...
<head>
  ...
  <link href=" <?php  echo asset('admin/assets/css/now-ui-dashboard.css')?> " rel="stylesheet" />
...
<body class="">
  ...
  <script src="<?php echo asset('admin/assets/js/now-ui-dashboard.min.js' )?>" type="text/javascript"></script><!-- Now Ui Dashboard DEMO methods, don't include it in your project! -->
